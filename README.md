...
1. Clone https://github.com/HiAPIAI/hiapi-happyhorse-1-0-video-skill
2. Copy the repository into your skill directory as hiapi-happyhorse-1-0-video
...
| Codex | Copy to `${CODEX_HOME:-$HOME/.codex}/skills/hiapi-happyhorse-1-0-video` |
| Claude Code | Copy to `~/.claude/skills/hiapi-happyhorse-1-0-video` |
| OpenCode | Copy to `~/.opencode/skills/hiapi-happyhorse-1-0-video` |
